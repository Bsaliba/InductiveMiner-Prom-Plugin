...
public class SATSolveLoop extends SATSolve {
	...
	public SATSolveLoop(DirectlyFollowsRelation directlyFollowsRelation, MiningParameters parameters, ThreadPool pool, AtomicResult result) {
	...
	public void solve() {
		...
		for (int i = 1; i <= Math.pow(directlyFollowsRelation.getDirectlyFollowsGraph().vertexSet().size(), 2)
